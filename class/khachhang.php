<?php
    ...
    class khachhang extends badminton
    {
        ...
        //             if (!in_array($maMau, $xetGiaTri)) {
        //                 // Nếu chưa xuất hiện, thêm vào mảng và hiển thị
        //                 $xetGiaTri[] = $maMau;

        //                 echo '<span class="box-size">
        //                         <input type="radio" class="form-check-input" name="txtmau" value="' . $maMau . '" checked>
        //                         <label class="form-check-label" for="txtmau">' . $maMau . '</label>
        //                     </span> ';
        //             }
        //         }
        //     }
