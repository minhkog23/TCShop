    ...
    <div class="card shadow mb-4">
        <form action="" method="post">
            <div class="card-header py-3">
                ...
                ?>
                <h5 class="m-0 font-weight-bold text-primary"><?php if(isset($title)) echo $title; else echo 'Chi tiết tài khoản';?></h5>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="mb-3 col-6">
                        ...
                        <input type="text" class="form-control" name="txt_hodem" id="txt_hodem" value="<?php if(isset($id_kh) && $id_kh != null) {echo $ho;} else if(isset($id_nv) && $id_nv != null) {echo $hoNV; } else {echo " ";}?>">
                    </div>
                    <div class="mb-3 col-6">
                        <label for="txt_ten" class="form-label">Tên</label>
                        <input type="text" class="form-control" name="txt_ten" id="txt_ten" value="<?php if(isset($id_kh) && $id_kh != null) {echo $ten;} else if(isset($id_nv) && $id_nv != null) {echo $tenNV; } else {echo " ";}?>">
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3 col-6">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" class="form-control" id="txt_email" name="txt_email" value="<?php if(isset($id_kh) && $id_kh != null) {echo $email;} else if(isset($id_nv) && $id_nv != null) {echo $emailNV; } else {echo " ";}?>">
                    </div>
                    <div class="mb-3 col-6">
                        <label for="txt_sdt" class="form-label">Số điện thoại</label>
                        <input type="text" class="form-control" id="txt_sdt" name="txt_sdt" value="<?php if(isset($id_kh) && $id_kh != null) {echo $sdt;} else if(isset($id_nv) && $id_nv != null) {echo $sdtNV; } else {echo " ";}?>">
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3 col-6">
                        <label for="password" class="form-label">Mật khẩu</label>
                        <input type="password" class="form-control" id="txt_pass" name="txt_pass" value="<?php if(isset($id_kh) && $id_kh != null) {echo $matKhau;} else if(isset($id_nv) && $id_nv != null) {echo $matKhauNV; } else {echo "";}?>">
                    </div>
                    <div class="mb-3 col-6">
                        <label for="txt_tinhTrang" class="form-label">Tình trạng tài khoản</label>
                        <input type="text" class="form-control" id="txt_tinhTrang" name="txt_tinhTrang" value="<?php if(isset($id_kh) && $id_kh != null) {echo $tinhTrang;} else if(isset($id_nv) && $id_nv != null) {echo $tinhTrangNV; } else {echo "";}?>"  readonly>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="txt_diachi" name="txt_diachi" value="<?php if(isset($id_kh) && $id_kh != null) {echo $diaChi;} else if(isset($id_nv) && $id_nv != null) {echo $diaChiNV; } else {echo " ";}?>">
                </div>
            </div>
